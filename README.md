...
## 0. What is Docker
In a few words: Docker is an open source software that help us to **DEPLOY** applications witout installing all the stuff required to make it work through a technology called container. 
